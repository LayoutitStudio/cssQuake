...
import { projectRoot, assertAssetState } from "./checkAssetState.mjs";

console.log("Asset integrity gate");
console.log("validates: prepared manifest, scene URLs, renderBundle, gameLogic, collision, model/sound path arrays");
...
const manifest = JSON.parse(readFileSync(path.join(generatedRoot, "q/manifest.json"), "utf8"));
const errors = [];
